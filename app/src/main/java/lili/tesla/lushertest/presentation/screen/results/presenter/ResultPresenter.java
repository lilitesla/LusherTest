...
public class ResultPresenter extends BasePresenter<ResultView> {
    ...
    public void calcResultTab3() {
        ...
        if (App.arrayTab3[5][0] < 3) { arrayTab3_1[0] = "-"; indexCoub += 1; }
        if (App.arrayTab3[5][0] > 8) { arrayTab3_1[0] = "+"; indexCoub += 1; }

        if (App.arrayTab3[5][1] < 3) { arrayTab3_1[1] = "-"; indexCoub += 2; }
        if (App.arrayTab3[5][1] > 8) { arrayTab3_1[1] = "+"; indexCoub += 2; }

        if (App.arrayTab3[5][2] < 5) { arrayTab3_1[2] = "-"; indexCoub += 3;}
        if (App.arrayTab3[5][2] > 10) { arrayTab3_1[2] = "+"; indexCoub += 3;}

        if (App.arrayTab3[5][3] < 3) { arrayTab3_1[3] = "-"; indexCoub += 4;}
        if (App.arrayTab3[5][3] > 9) { arrayTab3_1[3] = "+"; indexCoub += 4;}

        if (indexCoub.length() != 2) { indexCoub = "0"; }
